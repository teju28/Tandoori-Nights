    ...
    if ( $( '.lgx-switcher-loader').length ) {
        ...
        $( '.lgx-switcher-loader' ).switcher( {
            ...
            layout: [
                ...
                {
                    image: '1.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index1.html'
                },

                {
                    image: '2.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index2.html'
                },
                {
                    image: '3.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index3.html'
                },

                {
                    image: '4.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index4.html'
                },
                {
                    image: '5.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index5.html'
                },
                {
                    image: '6.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index6.html'
                },

                {
                    image: '7.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index7.html'
                },

                {
                    image: '8.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index8.html'
                },
                {
                    image: '9.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index9.html'
                },

                {
                    image: '10.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index10.html'
                },
                {
                    image: '11.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index11.html'
                },
                {
                    image: '12.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index12.html'
                },
                {
                    image: '13.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/index13.html'
                },
                {
                    image: '14.png',
                    link: 'http://logichunt.net/demo/html/Restaura/view/about.html'
                }
            ]
        } );
    } else {
